...
Скачайте [DEB-пакет PackeTech](https://github.com/rodmanvictor/packetech/releases/download/v0.3.2/packetech_0.3.2_amd64.deb).
...
```bash
sudo apt install ./packetech_0.3.2_amd64.deb
```
...
[TAR.GZ](https://github.com/rodmanvictor/packetech/releases/download/v0.3.2/packetech-0.3.2-linux-x86_64.tar.gz),
распакуйте его и запустите `packetech`. Установка Python не нужна.

```bash
tar -xzf packetech-0.3.2-linux-x86_64.tar.gz
cd packetech
./packetech
```
