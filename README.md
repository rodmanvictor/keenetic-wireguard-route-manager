...
|---|---|---|
| 🪟 **Windows 10/11** | [Скачать ZIP](https://github.com/rodmanvictor/packetech/releases/download/v0.3.0/packetech-0.3.0-windows-x86_64.zip) | [Установка в Windows](docs/guides/windows.md) |
| 🐧 **Ubuntu, Debian, Mint** | [Скачать DEB](https://github.com/rodmanvictor/packetech/releases/download/v0.3.0/packetech_0.3.0_amd64.deb) | [Установка в Linux](docs/guides/linux.md) |
| 🐧 **Другой Linux x86-64** | [Скачать TAR.GZ](https://github.com/rodmanvictor/packetech/releases/download/v0.3.0/packetech-0.3.0-linux-x86_64.tar.gz) | [Переносимая версия](docs/guides/linux.md#переносимая-версия) |
| 🍎 **Mac с Apple Silicon** | [Скачать DMG](https://github.com/rodmanvictor/packetech/releases/download/v0.3.0/packetech-0.3.0-macos-arm64.dmg) | [Установка в macOS](docs/guides/macos.md) |
| 🍎 **Mac с Intel** | [Скачать DMG](https://github.com/rodmanvictor/packetech/releases/download/v0.3.0/packetech-0.3.0-macos-x86_64.dmg) | [Установка в macOS](docs/guides/macos.md) |
...
- добавлять текущий сайт из расширения Chrome;
